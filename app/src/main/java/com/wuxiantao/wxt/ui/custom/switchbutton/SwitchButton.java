package com.wuxiantao.wxt.ui.custom.switchbutton;
...
public class SwitchButton extends View implements Checkable {
    ...
    //https://github.com/zcweng/SwitchButton/blob/master/library/src/main/res/values/switch_button_attrs.xml
     ...
     * @param paint
     */
    protected void drawUncheckIndicator(Canvas canvas,int color,float lineWidth,float centerX, float centerY,
