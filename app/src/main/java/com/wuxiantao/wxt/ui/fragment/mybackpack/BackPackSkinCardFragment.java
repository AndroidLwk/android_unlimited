...
public class BackPackSkinCardFragment extends MvpFragment<MyBackpackPrewenter, MyBackpackContract> implements MyBackpackContract {
                        ...
                        new TransferScratchCardPopupWindow.Build(getContext())
                                ...
                                .setOnItemClickListener((id, num, sxxh, pass) -> {
                                    if (id.equals("null")) {
                                        ...
                                        //调接口
                                        BackPackSkinCardFragment.this.id = id;
                                        BackPackSkinCardFragment.this.pass = pass;
                                        BackPackSkinCardFragment.this.num = num;
                                        showLoading();
