package com.wuxiantao.wxt.ui.custom.indicator;
 ...
 * Date: 2019/3/15 0015 14:27 8-19
 * Description: ${DESCRIPTION} ViewPager指示器
 * Author: Administrator Shiming-Shi
 */

public class VPindicator extends HorizontalScrollView{
...
//    = R.drawable.background_tab;//字体颜色的选择器
    ...
    public VPindicator(Context context, AttributeSet attrs, int defStyle) {
...
//        isSameLine = a.getBoolean(R.styleable.PagerSlidingTab_sameLine, isSameLine);
        ...
        wrapTabLayoutParams = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.WRAP_CONTENT, LinearLayout.LayoutParams.MATCH_PARENT);
        weightTabLayoutParams = new LinearLayout.LayoutParams(0, LinearLayout.LayoutParams.MATCH_PARENT, 1.0f);
