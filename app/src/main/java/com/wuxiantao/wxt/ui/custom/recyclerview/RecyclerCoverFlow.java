...
import com.wuxiantao.wxt.ui.custom.recyclerview.layoutmanager.CoverFlowLayoutManger;
import com.wuxiantao.wxt.utils.LogUtils;

/**
 * Company:成都可信网络科技有限责任公司
 * FileName:RecyclerCoverFlow
 * Author:android
 * Mail:2898682029@qq.com
 * Date:19-7-9 下午4:28 继承RecyclerView重写{@link #getChildDrawingOrder(int, int)}对Item的绘制顺序进行控制
...
public class RecyclerCoverFlow extends RecyclerView {
    ...
    public RecyclerCoverFlow(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        init();
        LogUtils.loge("RecyclerCoverFlow===========>");
    }
