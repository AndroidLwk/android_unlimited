 ...
 * Date:19-5-31 上午9:42
 * Description:${DESCRIPTION}圆角/圆形 图片
 */
public class RoundImageView extends AppCompatImageView {
    ...
    private void init(Context context,AttributeSet attrs){
        ...
        for (int i = 0;i < array.getIndexCount();i++){
            ...
            switch (attr){
                case R.styleable.RoundImageView_is_cover_src:
                    isCoverSrc = array.getBoolean(attr,isCoverSrc);
                    break;
                case R.styleable.RoundImageView_is_circle:
                    isCircle = array.getBoolean(attr,isCircle);
                    break;
                case R.styleable.RoundImageView_border_width:
                    borderWidth = array.getDimensionPixelSize(attr,borderWidth);
                    break;
                case R.styleable.RoundImageView_border_color:
                    borderColor = array.getColor(attr,borderColor);
                    break;
                case R.styleable.RoundImageView_inner_border_width:
                    innerBorderWidth = array.getDimensionPixelSize(attr,innerBorderWidth);
                    break;
                case R.styleable.RoundImageView_inner_border_color:
                    innerBorderColor = array.getColor(attr,innerBorderColor);
                    break;
                case R.styleable.RoundImageView_corner_radius:
                    cornerRadius = array.getDimensionPixelSize(attr,cornerRadius);
                    break;
                case R.styleable.RoundImageView_corner_top_left_radius:
                    cornerTopLeftRadius = array.getDimensionPixelOffset(attr,cornerTopLeftRadius);
                    break;
                case R.styleable.RoundImageView_corner_top_right_radius:
                    cornerTopRightRadius = array.getDimensionPixelOffset(attr,cornerTopRightRadius);
                    break;
                case R.styleable.RoundImageView_corner_bottom_left_radius:
                    cornerBottomLeftRadius = array.getDimensionPixelOffset(attr,cornerBottomLeftRadius);
                    break;
                case R.styleable.RoundImageView_corner_bottom_right_radius:
                    cornerBottomRightRadius = array.getDimensionPixelOffset(attr,cornerBottomRightRadius);
                    break;
                case R.styleable.RoundImageView_mask_color:
    ...
    private void initBorderRectF(){
        if (!isCircle){
            borderRectF.set(borderWidth / 2.0f,
                    borderWidth / 2.0f,
    ...
    public void setBorderWidth(int borderWidth) {
        this.borderWidth = DensityUtils.dp2px(borderWidth);
    ...
    public void setInnerBorderWidth(int innerBorderWidth) {
        this.innerBorderWidth = DensityUtils.dp2px(innerBorderWidth);
        clearInnerBorderWidth();
        invalidate();
    }
    ...
    public void setCornerTopLeftRadius(int cornerTopLeftRadius) {
        this.cornerTopLeftRadius = DensityUtils.dp2px(cornerTopLeftRadius);
        calculateRadiiAndRectF(true);
    }

    public void setCornerTopRightRadius(int cornerTopRightRadius) {
        this.cornerTopRightRadius = DensityUtils.dp2px(cornerTopRightRadius);
        calculateRadiiAndRectF(true);
    }

    public void setCornerBottomLeftRadius(int cornerBottomLeftRadius) {
        this.cornerBottomLeftRadius = DensityUtils.dp2px(cornerBottomLeftRadius);
        calculateRadiiAndRectF(true);
    }

    public void setCornerBottomRightRadius(int cornerBottomRightRadius) {
        this.cornerBottomRightRadius = DensityUtils.dp2px(cornerBottomRightRadius);
        calculateRadiiAndRectF(true);
    }
