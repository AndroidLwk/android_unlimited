 ...
 * Date: 2019/4/22 0022 11:01 8-19
 * Description: ${DESCRIPTION} 自定义ViewPager实现懒加载
...
//            mAdapter.registerDataSetObserver(mObserver);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        // For spread_anim implementation, or internal size is always 0.
        ...
        if (event.getAction() == KeyEvent.ACTION_DOWN) {
            switch (event.getKeyCode()) {
                ...
                case KeyEvent.KEYCODE_TAB:
                    handled = arrowScroll(event.hasNoModifiers() ? FOCUS_FORWARD : FOCUS_BACKWARD);
                    break;
            }
        }
        return handled;
