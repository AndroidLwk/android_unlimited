...
public class RecViewItemDecoration extends RecyclerView.ItemDecoration {
     ...
     */
    public RecViewItemDecoration(Context context, int orientation, int drawableId) {
        if (orientation != LinearLayoutManager.VERTICAL && orientation != LinearLayoutManager.HORIZONTAL) {
            throw new IllegalArgumentException(BaseApplication.getAppContext().getString(R.string.input_ok_args));
        }
     ...
     * @param orientation 列表方向
     */
    public RecViewItemDecoration(Context context, int orientation) {
     ...
     */
    public RecViewItemDecoration(int orientation, int dividerHeight, int dividerColor) {
        if (orientation != LinearLayoutManager.VERTICAL && orientation != LinearLayoutManager.HORIZONTAL) {
            throw new IllegalArgumentException(BaseApplication.getAppContext().getString(R.string.input_ok_args));
        }
        mOrientation = orientation;
     ...
     * @param dividerColor 分割线颜色
     */
    public RecViewItemDecoration(int orientation, int dividerColor) {
