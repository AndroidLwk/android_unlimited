 ...
 * Description:${DESCRIPTION} 邀请好友成功对话框
 */
public class InviteSuccessPopupWindow extends BasePopupWindow {


    public InviteSuccessPopupWindow(Build build) {
        super(build);
    }
    ...
    public static class Build extends BaseBuild {
        ...
        public Build(Context context) {
            super(context, R.layout.popupwindow_invite_success);
            setOnButtonListener();
        }
        ...
        public BasePopupWindow builder() {
            return new InviteSuccessPopupWindow(this);
        }
