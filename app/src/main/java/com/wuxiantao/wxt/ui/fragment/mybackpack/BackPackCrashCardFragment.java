...
public class BackPackCrashCardFragment extends MvpFragment<MyBackpackPrewenter, MyBackpackContract> implements MyBackpackContract {
                        ...
                        new TransferScratchCardPopupWindow.Build(getContext())
                                ...
                                .setOnItemClickListener((id, num, sxxh, pass) -> {
                                    if (id.equals("null")) {
                                        ...
                                        //调接口
                                        BackPackCrashCardFragment.this.id = id;
                                        BackPackCrashCardFragment.this.pass = pass;
                                        BackPackCrashCardFragment.this.num = num;
                                        showLoading();
