...
public class ApplyWithdrawModel extends WithdrawModel {

    //获取红包提现信息
    public void getReadBagWithdrawInfo(BaseObserver<RedBagWithdrawInfoBean> observer, String token){
        HttpManager.newInstance()
                .createService(CommissionService.class)
                .getRedBagWithdrawInfo(token)
