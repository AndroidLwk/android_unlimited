package com.ssm.androidkeystoresign;
 ...
 * FileName:AndroidKeyStoreRSAUtils
 * Author:android
 * Mail:2898682029@qq.com
 * Date:20-1-5 下午12:17
 * Description:${DESCRIPTION} 生成RSA秘钥工具类
 */
public final class AndroidKeyStoreRSAUtils {
    //加密填充方式
    public static final String ECB_PKCS1_PADDING = "RSA/ECB/PKCS1Padding";
    //秘钥默认长度
    public static final int DEFAULT_KEY_SIZE = 2048;
    // 当要加密的内容超过bufferSize，则采用partSplit进行分块加密
    public static final byte[] DEFAULT_SPLIT = "#HUANGXIAOGUO#".getBytes();
    // 当前秘钥支持加密的最大字节数
    public static final int DEFAULT_BUFFERSIZE = (DEFAULT_KEY_SIZE / 8) - 11;
    //自己给你的别名，方便在keystore中查找秘钥
    public static final String SAMPLE_ALIAS = "wuxiantao_key";
    ...
    public static KeyPair generateRSAKeyPair(Context context) throws InvalidAlgorithmParameterException,
